<style>
  /* Biar tinggi editornya enak dilihat */
  .ck-editor__editable_inline {
    min-height: 200px;
  }

  /* Memastikan font Arab tampil dengan baik di dalam editor */
  .ck-content {
...
<div class="modal fade" id="addForm" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="weddingWizard" action="{{ route('save.undangan') }}" method="POST"
          ...
          <div class="step-wizard active" id="step-1">
            ...
            <div class="mb-3">
              ...
              <textarea id="editor" name="quote_quran" class="form-control" rows="4"
            ...
            <div class="row">
              ...
              <div class="col-md-6 ps-md-4">
                <div class="p-3">
                  ...
                  <div class="text-center mb-4">
                    <div class="position-relative d-inline-block">
                      <img id="prev_wanita" src="https://via.placeholder.com/150?text=Foto+Wanita"
                        class="rounded-circle shadow-sm border border-3 border-white"
                        style="width: 130px; height: 130px; object-fit: cover; background: #f8f9fa;">
                  ...
                  <div class="row g-2 mb-3">
                    <div class="col-sm-8">
                      <label class="form-label small">Nama Panggilan</label>
                      <input type="text" id="m_panggilan_wanita" name="m_wanita_panggilan" class="form-control"
                        placeholder="Riska">
                    </div>
                    <div class="col-sm-4">
                      <label class="form-label small">Anak Ke-</label>
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('#m_panggilan_pria, #m_panggilan_wanita').on('input', generateSlug);
  ...
  $('#weddingWizard').submit(function (e) {
    e.preventDefault();

    let formData = new FormData(this);

    // Ambil data dari CKEditor secara manual
    const editorValue = document.getElementById('editor').value;
    formData.set('quote_quran', editorValue);

    let btnSubmit = $(this).find('button[type="submit"]');

    $.ajax({
      url: $(this).attr('action'), // Pastikan form punya action="/wedding/save"
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
      ...
      success: function (res) {
        swal.alert("Sukses", "Undangan berhasil disimpan!", "success")
        .then(() => {
            window.location.reload();
        });
      },
      error: function (xhr) {
        btnSubmit.prop('disabled', false).text('SIMPAN & PUBLIKASI');
        let errorMsg = xhr.responseJSON?.message || "Terjadi kesalahan.";
        alert("Error: " + errorMsg);
        console.log(xhr.responseJSON.errors); // Cek error validasi di console
      }
    });
  });
