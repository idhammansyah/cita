...
<body>
  ...
  <script>
    $(document).ready(function () {
      ...
      const totalPages = 5; // 0 sampai 5 = 6 total spreads

      function updateButtons() {
        // Di mode mobile, tombol selalu ON, tapi flip tetap aktif sekarang
        if ($(window).width() <= 768) {
      ...
      function showPage(pageNum) {
        ...
        // ❌ DULUNYA return (flip mati)
        // ❌ Sekarang: flip aktif di mobile
        if ($(window).width() <= 768) {
          // tetap lanjut ke flip logic
        }
        ...
        setTimeout(function () {
          ...
          if (pageNum === 0) {
            $('#page1-right').removeClass('hide');

          } else if (pageNum === 1) {
            $('#page1-right').addClass('flipped');
            $('#page1-back').removeClass('hide').addClass('fade-in');
            $('#page2-right').removeClass('hide');

          } else if (pageNum === 2) {
            $('#page1-right').addClass('flipped');
            $('#page2-right').addClass('flipped');
            $('#page2-back').removeClass('hide').addClass('fade-in');
            $('#page3-right').removeClass('hide');

          } else if (pageNum === 3) {
            $('#page1-right').addClass('flipped');
            $('#page2-right').addClass('flipped');
            $('#page3-right').addClass('flipped');
            $('#page3-back').removeClass('hide').addClass('fade-in');
            $('#page4-right').removeClass('hide');

          } else if (pageNum === 4) {
            $('#page1-right').addClass('flipped');
            $('#page2-right').addClass('flipped');
            $('#page3-right').addClass('flipped');
            $('#page4-right').addClass('flipped');
            $('#page4-back').removeClass('hide').addClass('fade-in');
            $('#page5-right').removeClass('hide');
            ...
            $('#page3-right').addClass('flipped');
            $('#page4-right').addClass('flipped');
            $('#page5-right').addClass('flipped');
            $('#page5-back').removeClass('hide').addClass('fade-in');
          }
      ...
      /* ====================================================
         GESTURE SWIPE — FIXED & 100% WORKING
      ===================================================== */
